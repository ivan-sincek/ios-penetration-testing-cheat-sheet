 ...
 *
 * You might want to call 'openURL()' for the target URL (deeplink) once before fuzzing to dismiss any prompt that might appear:
...
function fuzz(url) {
	...
	Fuzzer.prototype.checkForCrash = function(done) {
		console.log("sulo je 1");
		homeSinglePress();
		console.log("sulo je 2");
